...
public class TSPClosestDeliveryTest {
	...
	{
		TSPClosestDelivery tspClosestDelivery = new TSPClosestDelivery();
		float value = tspClosestDelivery.bound((long)2, myNotVisited, myVisited, myListDeliveries, myTreeGraph);
	...
	public final void testStartTSP() throws Exception {
		TSPClosestDelivery tspClosestDelivery = new TSPClosestDelivery();
		tspClosestDelivery.startTSP(1000, myListDeliveries.size(), myTreeGraph);
		assertEquals(myBestSolution, tspClosestDelivery.getBestSolution());
